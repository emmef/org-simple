#ifndef ORG_SIMPLE_M_REFERENCE_H
#define ORG_SIMPLE_M_REFERENCE_H
/*
 * org-simple/Reference.h
 *
...
static void *ref_counter_pointer_check_null_init(void *ptr) {
  ...
  throw std::invalid_argument(
      "org::simple::UntypedRefCountPointer: nullptr");
}
#else
...
#endif // ORG_SIMPLE_M_REFERENCE_H
