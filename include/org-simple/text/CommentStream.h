#ifndef ORG_SIMPLE_TEXT_M_COMMENT_STREAM_H
#define ORG_SIMPLE_TEXT_M_COMMENT_STREAM_H
/*
 * org-simple/text/CommentStream.h
 *
...
#endif // ORG_SIMPLE_TEXT_M_COMMENT_STREAM_H
