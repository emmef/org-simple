#ifndef ORG_SIMPLE_TEXT_M_NUMBER_PARSER_H
#define ORG_SIMPLE_TEXT_M_NUMBER_PARSER_H
/*
 * org-simple/text/NumberParser.h
 *
...
struct NumberParser {
  ...
  requires(text::hasInputStreamSignature<S, C> &&isIntegralNumber<V>) //
    ...
    auto classifier = text::Classifiers::defaultInstance<C>();
    bool negative = false;
...
#endif // ORG_SIMPLE_TEXT_M_NUMBER_PARSER_H
